    ...
    <>
      <section className="md:flex md:gap-4 md:justify-items-center">
        <ul className="grow mx-9 my-12 p-4 shadow-xl shadow-green-500 rounded-xl bg-green-100 text-center">
          ...
          <li>DRAWS - 0</li>
          <li>LOSSES - 0</li>
          <br /> <li>TEAM GOALS SCORED - 8</li>
          <li>TEAM GOALS SAVED - 3</li>
          <li>TEAM SHOTS TAKEN - 41</li>
          <li>TEAM SHOOTING % - 19.5%</li>
          <hr className="bg-green-300 h-0.5 my-4" />
          <li>WILLIAM KING</li>
          <br />
          ...
          <li>GOALS SAVED - 3</li>
          <li>SHOTS TAKEN - 12</li>
          <li>SHOOTING % - 16.7%</li>
          <hr className="bg-green-300 h-0.5 my-4" />
          <li>PATRICK RYAN</li>
          <br />
          <li>GOALS SCORED - 5</li>
          <li>GOALS SAVED - 0</li>
          <li>SHOTS TAKEN - 26</li>
          <li>SHOOTING % - 19.2%</li>
        </ul>
        <ul className="mx-9 my-12 p-4 shadow-xl shadow-green-500 rounded-xl bg-green-100 text-center">
          ...
          <li>DRAWS - 0</li>
          <li>LOSSES - 1</li>
          <br /> <li>TEAM GOALS SCORED - 7</li>
          <li>TEAM GOALS SAVED - 10</li>
          <li>TEAM SHOTS TAKEN - 39</li>
          <li>TEAM SHOOTING % - 17.9%</li>
          <hr className="bg-green-300 h-0.5 my-4" />
          ...
          <li>GOALS SAVED - 4</li>
          <li>SHOTS TAKEN - 14</li>
          <li>SHOOTING % - 21.4%</li>
          <hr className="bg-green-300 h-0.5 my-4" />
          <li>GIULIO LAURA</li>
          <br />
          <li>GOALS SCORED - 4</li>
          <li>GOALS SAVED - 6</li>
          <li>SHOTS TAKEN - 23</li>
          <li>SHOOTING % - 17.4%</li>
        </ul>
        <ul className="mx-9 my-12 p-4 shadow-xl shadow-green-500 rounded-xl bg-green-100 text-center">
          ...
          <li>DRAWS - 2</li>
          <li>LOSSES - 0</li>
          <br /> <li>TEAM GOALS SCORED - 3</li>
          <li>TEAM GOALS SAVED - 14</li>
          <li>TEAM SHOTS TAKEN - 24</li>
          <li>TEAM SHOOTING % - 12.5%</li>
          <hr className="bg-green-300 h-0.5 my-4" />
        ...
        <ul className="mx-9 md:mx-5 my-12 p-4 shadow-xl shadow-green-500 rounded-xl bg-green-100 text-center">
          ...
          <li>DRAWS - 2</li>
          <li>LOSSES - 2</li>
          <br /> <li>TEAM GOALS SCORED - 9</li>
          <li>TEAM GOALS SAVED - 11</li>
          <li>TEAM SHOTS TAKEN - 42</li>
          <li>TEAM SHOOTING % - 21.4%</li>
          <hr className="bg-green-300 h-0.5 my-4" />
          <li>ALYSSA BRUNS</li>
          <br />
          <li>GOALS SCORED - 0</li>
          ...
          <li>GOALS SCORED - 3</li>
          <li>GOALS SAVED - 3</li>
          <li>SHOTS TAKEN - 16</li>
          <li>SHOOTING % - 18.8%</li>
          <hr className="bg-green-300 h-0.5 my-4" />
          <li>TOMMY MAC GUINNESS</li>
          <br />
          <li>GOALS SCORED - 6</li>
          <li>GOALS SAVED - 3</li>
          <li>SHOTS TAKEN - 24</li>
          <li>SHOOTING % - 25.0%</li>
        </ul>
        <ul className="mx-9 my-12 p-4 shadow-xl shadow-green-500 rounded-xl bg-green-100 text-center">
          ...
          <li>LOSSES - 1</li>
          <br /> <li>TEAM GOALS SCORED - 8</li>
          <li>TEAM GOALS SAVED - 8</li>
          <li>TEAM SHOTS TAKEN - 27</li>
          <li>TEAM SHOOTING % - 29.6%</li>
          <hr className="bg-green-300 h-0.5 my-4" />
