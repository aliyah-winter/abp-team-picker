    ...
    <>
      <section className="md:grid md:grid-cols-3">
        <ul className="grow mx-9 my-12 p-4 shadow-xl shadow-green-500 rounded-xl bg-green-100 text-center">
          ...
          <li>DRAWS - 0</li>
          <li>LOSSES - 0</li>
          <br /> <li>TEAM GOALS SCORED - 10</li>
          <li>TEAM GOALS SAVED - 6</li>
          <li>TEAM SHOTS TAKEN - 56</li>
        ...
        <ul className="mx-9 my-12 p-4 shadow-xl shadow-green-500 rounded-xl bg-green-100 text-center">
          ...
          <li>TEAM GOALS SAVED - 13</li>
          <li>TEAM SHOTS TAKEN - 47</li>
          <li>TEAM SHOOTING % - 17.0%</li>
          <hr className="bg-green-300 h-0.5 my-4" />
        ...
        <ul className="mx-9 my-12 p-4 shadow-xl shadow-green-500 rounded-xl bg-green-100 text-center">
          ...
          <li>TEAM GOALS SAVED - 16</li>
          <li>TEAM SHOTS TAKEN - 32</li>
          <li>TEAM SHOOTING % - 15.6%</li>
          <hr className="bg-green-300 h-0.5 my-4" />
        ...
        <ul className="mx-9 my-12 p-4 shadow-xl shadow-green-500 rounded-xl bg-green-100 text-center">
          ...
          <li>LOSSES - 2</li>
          <br /> <li>TEAM GOALS SCORED - 9</li>
          <li>TEAM GOALS SAVED - 12</li>
          <li>TEAM SHOTS TAKEN - 36</li>
