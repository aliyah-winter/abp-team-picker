...
function Calendar() {
  return (
    <>
      <ul className=" flex-col justify-center items-center mx-4 p-4 shadow-2xl shadow-purple-500 rounded-xl">
        <li>Week 1</li>
        <li>18:30 | Team 1 vs Team 4</li>
        <li>19:00 | Team 2 vs Team 3</li>
        <li>Team 5 - BYE</li>
      </ul>
      <ul className="mx-4 p-4 shadow-2xl shadow-purple-500 rounded-xl">
        <li>Week 2</li>
